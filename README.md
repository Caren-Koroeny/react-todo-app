...
**[React Todo list App]** is a project that demonstrates the use of React library to create a simple Todo list app
...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone https://github.com/Caren-Koroeny/react-todo-app.git
